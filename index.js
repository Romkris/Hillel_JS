...
//  && - повертає значення "qwerty", якщо обидва операнди істинні, поверне друге;
// Результат: друге "qwerty"
...
// '0' && 1 - якщо хочаб один з операторів хибний, поверне останнє значення 1
// 0 || 1 - якщо оператор перший хибний, то поверне другий. Другий 1
// Результат: 1
